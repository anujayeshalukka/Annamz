      ...
      <div className="container mx-auto grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-6">
            <a href="#" className="p-2 border border-gray-200 rounded-full hover:bg-gold hover:text-white transition-all">
              <Camera size={18} />
            </a>
            <a href={`tel:${CONTACT_INFO.whatsapp}`} className="p-2 border border-gray-200 rounded-full hover:bg-gold hover:text-white transition-all">
              <Phone size={18} />
            </a>
          </div>
